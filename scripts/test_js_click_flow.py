...
async def main():
    async with async_playwright() as p:
        ...
        print("Waiting for chat room hydration...", flush=True)
        for _ in range(12):
        ...
        print(f"Total conversations extracted via JS: {len(conv_list)}", flush=True)
        ...
        await page.screenshot(path="tests/test_screenshots/js_click_flow_verified.png")
        print("\nScreenshot saved to tests/test_screenshots/js_click_flow_verified.png", flush=True)
        await context.close()
