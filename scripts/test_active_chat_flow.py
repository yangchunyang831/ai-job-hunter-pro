...
async def main():
    async with async_playwright() as p:
        ...
        print(f"3. Total conversations in Chat Inbox: {count}", flush=True)
        ...
        for i in range(count):
            try:
                ...
                item = page.locator(".user-list-content li, .chat-user-list li, .geek-chat-list li, ul.user-list li, .main-list li").nth(i)
